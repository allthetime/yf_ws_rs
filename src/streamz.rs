...
pub struct Yaticker {
    ...
    #[prost(enumeration = "yaticker::QuoteType", tag = "6")]
    pub quote_type: i32,
    #[prost(enumeration = "yaticker::MarketHoursType", tag = "7")]
    ...
    #[prost(enumeration = "yaticker::OptionType", tag = "20")]
...
/// Nested message and enum types in `yaticker`.
pub mod yaticker {
    #[derive(
        Clone,
        Copy,
    ...
    impl MarketHoursType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::RegularMarket => "REGULAR_MARKET",
                Self::PostMarket => "POST_MARKET",
                Self::ExtendedHoursMarket => "EXTENDED_HOURS_MARKET",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
